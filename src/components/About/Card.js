...
export default function Card() {
  return (
    <><div className='text-center grid xl:grid-cols-4 xl:grid-rows-2 w-2/4 gap-y-10 xs:grid-cols-1 xs:grid-rows-1 md:grid-rows-2 md:grid-cols-2'>
          <div className="container-card w-full h-40  mr-8 max-w-sm xs:w-2/4 md:w-3/4 bg-pink border border-gray-200  rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <p className="text relative mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">HTML</p>
          </div>
          <div className="container-card w-full h-40  mr-8 max-w-sm xs:w-2/4 md:w-3/4 bg-pink border border-gray-200  rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
